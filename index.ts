...
while (loop) {
  ...
  if (input === "Pakistan Rs") {
    if (output === "Us Dollar") {
      console.log(
        `The ${amount} Pakistan Rupees is equal to ${amount / 281} Us Dollar`
      );
    } else if (output === "Saudi Riyal") {
      console.log(
        `The ${amount} Pakistan Rupees is equal to ${amount / 75} Saudi Riyal`
      );
    }
  } else if (input === "Us Dollar") {
    if (output === "Pakistan Rs") {
      console.log(
        `The ${amount} Us Dollar is equal to ${amount * 281} Pakistan Rupees`
      );
    } else if (output === "Saudi Riyal") {
      console.log(
        `The ${amount} Us Dollar is equal to ${amount * 3.75} Saudi Riyal`
      );
    }
  } else if (input === "Saudi Riyal") {
    if (output === "Pakistan Rs") {
      console.log(
        `The ${amount} Saudi Riyal  is equal to ${amount * 75} Pakistan Rupees`
      );
